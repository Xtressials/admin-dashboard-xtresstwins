...
function _sanitizeAppName(name) {
    name = name || 'node-red-admin-dashboard-xtresstwins';
...
if (!cloudantUrl) {
    ...
    settings.cloudantService = {
        ...
        db: process.env.NODE_RED_STORAGE_DB_NAME || "node-red-admin-dashboard-xtresstwins",
        // The prefix for all document names stored by this instance.
        prefix: process.env.NODE_RED_STORAGE_APP_NAME || "node-red-admin-dashboard-xtresstwins"
    }
